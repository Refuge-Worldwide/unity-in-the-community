...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        'fixed inset-0 z-50 bg-black/20 transition-opacity duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:[backdrop-filter:blur(2px)]',
        className
      )}
      {...props}
    />
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={<Button variant="ghost" className="absolute top-4 right-3" size="icon" />}
          >
