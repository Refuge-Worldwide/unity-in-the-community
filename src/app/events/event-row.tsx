...
export function EventRow({ event }: { event: Event }) {
  ...
  return (
    <div
      ...
      className={`grid gap-3 border-t border-foreground border-t-[var(--border-width)] py-4 md:grid-cols-[1fr_2fr] md:gap-12 md:py-7 ${hasDescription ? 'cursor-pointer md:cursor-auto' : ''}`}
    >
